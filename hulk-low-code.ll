...
@38 = private unnamed_addr constant [7 x i8] c"false\0A\00", align 1
@39 = private unnamed_addr constant [6 x i8] c"true\0A\00", align 1
@40 = private unnamed_addr constant [4 x i8] c"%g\0A\00", align 1
...
entry:
  ...
  %22 = call i32 @puts(ptr @38)
  %23 = call i32 (ptr, ...) @printf(ptr @40, double -4.700000e+00)
  ret i32 0
}
